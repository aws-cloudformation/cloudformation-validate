...
use validation_engine::{EngineConfig, ValidationEngine, validate_bytes_with_path};
...
impl WasmSemanticModel {
    ...
    pub fn to_diagnostic_model(&self) -> Result<JsValue, JsValue> {
        to_js(&self.model.to_diagnostic_json())
    }
